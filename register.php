            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/Capstoneproject/login.php?verification='.$code.'">http://localhost/Capstone/login.php?verification='.$code.'</a></b>';
